...
bruno_image = face_recognition.load_image_file("../media/train/bruno_lima/bruno_05.png")
bruno_face_encoding = face_recognition.face_encodings(bruno_image)[0]

joao_image = face_recognition.load_image_file("../media/train/joao_victor/joao_01.jpg")
...
while True:
    ...
    process_this_frame = not (frame_index % process_each_n)
